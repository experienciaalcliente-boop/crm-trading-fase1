...
const ESTADO_COLORS = {
  ...
  Cancelado:   { color: 'var(--text-muted)', bg: 'rgba(80,96,128,0.1)',   border: 'rgba(80,96,128,0.25)'  },
}
    ...
    <div style={{ display:'flex', flexDirection:'column', height:'100%' }}>
      ...
      <div style={{ padding:'14px 16px', borderBottom:'1px solid var(--border-default)', background:'rgba(255,255,255,0.02)' }}>
        <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between' }}>
          <div>
            <div style={{ fontSize:12, fontWeight:700, color:'var(--text-primary)' }}>Compromisos</div>
            <div style={{ fontSize:10, color:'var(--text-muted)', marginTop:2 }}>Bandeja de seguimiento</div>
          </div>
        ...
        {loading ? (
          ...
          return (
            <div key={c.id} style={{ padding:'11px 14px', borderBottom:'1px solid rgba(255,255,255,0.05)' }}>
              ...
              {/* Descripción */}
              <div style={{ fontSize:11, color:'var(--text-secondary)', marginBottom:6, lineHeight:1.4 }}>{c.descripcion}</div>
              ...
              <div style={{ display:'flex', alignItems:'center', gap:6, marginBottom:8 }}>
                ...
                <span style={{ fontSize:10, color:'var(--text-muted)' }}>{c.alumno?.programa}</span>
              </div>

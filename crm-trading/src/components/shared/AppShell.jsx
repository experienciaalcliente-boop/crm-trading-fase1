...
import { Phone, Upload, BarChart2, CreditCard, MonitorSmartphone, ChevronRight, ChevronDown, GraduationCap, LogOut, UserCircle, Sun, Moon, ShoppingBag, CalendarCheck, Award, RotateCcw, HeartHandshake, Wallet, TrendingUp, ListChecks, ChevronsLeft, ChevronsRight, MessageCircle } from 'lucide-react'
...
export const NAV = [
  ...
  { to:'/recuperacion-seguimiento', icon:MessageCircle, label:'Seg. Recuperación', sub:'Correo + WhatsApp, A–D', roles:['supervisor'], group:null },
